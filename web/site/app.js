(() => {
  ...
  var hostConfig = {
    ...
    appendChildToContainer: (container2, child) => container2.appendChild(child),
    insertBefore: (parent, child, before) => parent.insertBefore(child, before),
    insertInContainerBefore: (container2, child, before) => container2.insertBefore(child, before),
    removeChild: (parent, child) => parent.removeChild(child),
    removeChildFromContainer: (container2, child) => container2.removeChild(child),
  ...
  var container = reconciler.createContainer(
    root,
    0,
    null,
    false,
